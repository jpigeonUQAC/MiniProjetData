...
<br><br>
Instructions Notebook : Pour ouvrir le fichier notebook, ouvrez d'abord l'application Anaconda, puis Jupyter Notebook. Puis sélectionnez le Notebook.ipynb dans le dossier présent.<br>
...
<br><br>
Instructions Streamlit : Pour ouvrir le fichier Python Streamlit, ouvrez le terminal et inscrivez "Streamlit run Streamlit.py". Ceci vous ouvrira une page sur votre navigateur web.<br>
